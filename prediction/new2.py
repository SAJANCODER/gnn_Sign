...
# Import custom layers from train_model.py
# IMPORTANT: These layers must be defined in the script that loads the model,
# or imported from a module that defines them.
from train_model import CustomGCNConv, GlobalSumPool
...
def load_inference_model(model_path, classes_file='classes.txt'):
    ...
    try:
        ...
        print(
            "Please ensure 'final_isl_gnn_model.h5' exists and the custom layers (CustomGCNConv, GlobalSumPool) are correctly defined/imported.")
        return None, None

    # Load class labels from the file generated by train_model.py
    classes = []
    if os.path.exists(classes_file):
        ...
        print(
            f"🚫 Error: classes.txt not found at {classes_file}. Please ensure train_model.py was run successfully to generate this file.")
        return None, None
...
def main():
    model_path = 'final_isl_gnn_model (1).h5'  # Path to your trained model
    classes_file = 'classes.txt'  # Path to your classes file
